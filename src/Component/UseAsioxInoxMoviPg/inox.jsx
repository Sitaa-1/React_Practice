...
export function Inox(){
        ...
        return(
            <div className="contsiner-fluid p3">
                <header>
                    <div className="text-center fw-bold fs-4">Inox Movie</div>
                </header>
                <section className="mt-3 d-flex flex-row">
                    {
                        movies.map(movie=>
                            <div key={movie.title} className="card m-1 p-1 w-25">
                                ...
                                <div className="card-footer">
                                    <button className="btn btn-warning w-100">Book Tickit</button>
                                </div>
                            </div>
                        )
                    }
